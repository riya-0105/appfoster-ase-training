...
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>">
    ...
    <div class="container-header">
                ...
                <div class="entries_count_container">
                    <button class="entries_button" onclick="window.location.href='/create-project'">Create New Project</button>
            ...
            <table>
                ...
                <?php $__currentLoopData = $projectUser; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr data-project-id="<?php echo e($data['project']->id); ?>">
                    <td><?php echo e($data['project']->{'Project Title'}); ?></td>
                    <td><?php echo e($data['user']->name); ?></td>
                    <td>
                        <button type="button" class="btn btn-primary btn-outline-success"  data-bs-toggle="modal" data-bs-target="#project_view<?php echo e($data['project']->id); ?>">View</button>
                        ...
                        ?>
                        <div class="modal fade" id="project_view<?php echo e($data['project']->id); ?>" tabindex="-1" role="dialog"  aria-labelledby="project_view" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <h6>Project ID = <?php echo e($data['project']->id); ?></h6><br><br>
                                        <h6>Project Name = <?php echo e($data['project']->{"Project Title"}); ?></h6><br><br>
                                        <h6>Technology Used = <?php echo e($technology_string); ?></h6>
                                        <br><br>
                                        <h6>Project Description = <?php echo e($data['project']->{'Project Description'}); ?></h6><br><br>
                                        <h6>User Name = <?php echo e($data['user']->name); ?></h6><br><br><br>
                                    </div>
                        ...
                        <button type="button" class="btn btn-primary btn-outline-danger" data-bs-toggle="modal" data-bs-target="#userdeleteConfirm<?php echo e($data['project']->id); ?>">Delete</button>

                            
                            <div class="modal fade" id="userdeleteConfirm<?php echo e($data['project']->id); ?>" tabindex="-1" role="dialog" aria-labelledby="userdeleteConfirm" aria-hidden="true">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="mb-0 modal-footer">
                                        <form class="mb-0 d-flex" data-project="<?php echo e($data['project']->id); ?>" id="delete_form_project">
                                            <button type="button" class="btn btn-secondary btn-outline-success" data-bs-dismiss="modal">Close</button>
                                            <button type="submit" class="btn btn-primary btn-outline-danger" data-bs-dismiss="modal" id="data_delete<?php echo e($data['project']->id); ?>">Delete</button>
                                        </form>  
                                    </div>
                                </div>
                            </div>
                        ...
                        <button type="button" class="btn btn-primary btn-outline-light edit_project_btn" data-project="<?php echo e(json_encode($data)); ?>">Edit</button>
                        

                        <div class="modal fade" id="edit_data<?php echo e($data['project']->id); ?>" tabindex="-1" role="dialog" aria-labelledby="edit_project_data" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                    ...
                                    <form class="modify_form<?php echo e($data['project']->id); ?>" id="edit_form_project">
                                        <div class="modal-body">
                                        <div class="mb-3">
                                            <label for="id<?php echo e($data['project']->id); ?>" class="form-label">Project Id</label>
                                            <input placeholder="<?php echo e($data['project']->id); ?>" type="text" class="form-control" id="id<?php echo e($data['project']->id); ?>" name="id" disabled>
                                        </div>
                                        <div class="mb-3">
                                            <label for="projectTitle<?php echo e($data['project']->id); ?>" class="form-label">Project Title</label>
                                            <input placeholder="<?php echo e($data['project']->{'Project Title'}); ?>" type="password" class="form-control" id="projectTitle<?php echo e($data['project']->id); ?>" name="projectTitle" disabled>
                                        </div>
                                        <div class="mb-3">
                                            <label for="user_name<?php echo e($data['project']->id); ?>" class="form-label">User Name</label>
                                            <input placeholder="<?php echo e($data['user']->name); ?>" type="text" class="form-control" id="user_name<?php echo e($data['project']->id); ?>" name="user_name" disabled>
                                        </div>
                                        <div class="mb-3">
                                            <label for="technologyUsed<?php echo e($data['project']->id); ?>" class="form-label">Technology Used</label>
                                            <input type="text" class="form-control" id="technologyUsed<?php echo e($data['project']->id); ?>" name="Technology Used" placeholder="<?php echo e($technology_string); ?>">
                                            <div id="selectedTechnologies<?php echo e($data['project']->id); ?>" class="d-flex selected_tech"></div>
                                            <button type="button" class="btn btn-primary w-auto" id="addTechnology<?php echo e($data['project']->id); ?>">Add Technology</button>
                                        </div>
                                        <div class="mb-3">
                                            <label for="projectDescription<?php echo e($data['project']->id); ?>" class="form-label">Project Description</label>
                                            <input placeholder="<?php echo e($data['project']->{'Project Description'}); ?>" type="text" class="form-control" id="projectDescription<?php echo e($data['project']->id); ?>" name="Project Description">
                                        </div>
                                        <div class="modal-footer">
        ...
        <script>
                ...
                data_project.forEach(data_project_id => {
                    ...
                    document.querySelector(`.modify_form${id}`).addEventListener("submit", async() => {
                        ...
                        try {
                            ...
                            const response = fetch(`http://127.0.0.1:8000/api/modify-projects/${id}`, {
                                method: 'POST', 
                                headers: {
            ...
            $(document).ready(function() {
                ...
                $('#delete_form_project').submit(async function(e) {
                    ...
                    console.log(data);
                    const formUrl = `/api/delete-project/${data}`;
...
</html><?php /**PATH C:\Users\lenovo\Documents\appfoster-ase-training\task-13-Laravel-Docker\Project\resources\views/projects.blade.php ENDPATH**/ ?>