...
async function edit_data(project, user) {
            ...
            <div class="modal-content">
                ...
                <form class="modify_form">
                    ...
                    <div class="mb-3">
                        ...
                        <input placeholder=${project.id} type="text" class="form-control" id="project_id" name="project_id" disabled>
                    </div>
                    <div class="mb-3">
    ...
    modify_form.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = fetch(`http://127.0.0.1:8000/api/host/modify_projects/${project.id}`, {
                method: 'POST', 
                headers: {
                    'Content-Type': 'application/json',
                },
            ...
            console.log(`http://127.0.0.1:8000/api/host/modify_projects/${project.id}`);
