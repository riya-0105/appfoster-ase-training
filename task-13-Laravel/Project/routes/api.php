...
//-- delete user data
Route::get('/host/delete_user/{id}', [PostController::class, 'destroy']);
...
//-- update data
Route::post('host/modify_projects/{project_id}', [ProjectController::class, 'update']);

//-- delete data
Route::get('/host/delete_project/{id}', [ProjectController::class, 'destroy']);
